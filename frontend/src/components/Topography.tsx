// Topography — animated topographic-contour WebGL background (from React Bits,
// adapted to TS). Colors default to our brand blue-violet palette.
...
const ctxMap = new WeakMap<Element, Ctx>();
...
const Topography = ({
  ...
  useEffect(() => {
    ...
    const loop = (t: number) => {
      ...
      const mv = u.uMouse.value as Float32Array;
      mv[0] = currentMouse[0];
      mv[1] = currentMouse[1];
